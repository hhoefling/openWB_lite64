				...
				<div class="card border-secondary">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<div class="form-row mb-1">
								<div class="col-md-4">
									<label class="col-form-label">MHI Klimageräte MQTT Brige</label>
								</div>
								<div class="col">
									<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-outline-info<?php if($mqtt2mhiold == 0) echo " active" ?>">
											<input type="radio" name="mqtt2mhi" id="mqtt2mhiOff" value="0"<?php if($mqtt2mhiold == 0) echo " checked=\"checked\"" ?>>Aus
										</label>
										<label class="btn btn-outline-info<?php if($mqtt2mhiold == 1) echo " active" ?>">
											<input type="radio" name="mqtt2mhi" id="mqtt2mhiOn" value="1"<?php if($mqtt2mhiold == 1) echo " checked=\"checked\"" ?>>An
										</label>
									</div>
									<span class="d_label">openwb.conf  mqtt2mhi [0|1]</span>
									<span class="form-text small">Wenn aktiviert, wird die MHI-MQTT Bridge gestartet.</span>
								</div>
							</div>
						</div>
						<div class="form-group">
