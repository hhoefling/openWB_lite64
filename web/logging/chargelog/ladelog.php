			...
			<div class="row justify-content-center">
				<div class="col-8 col-sm-6 col-md-5 col-lg-4">
					<div class="input-group mb-3">
						<i class="fa fa-caret-square-left fa-lg vaRow mr-4" title="vorheriger Monat" id="prevmonth"></i>
						<input class="form-control datepicker" id="theDate" type="text" readonly>
						<div class="input-group-append">
							<span class="input-group-text fa fa-calendar-alt fa-lg vaRow"></span>
						</div>
						<i class="fa fa-caret-square-right fa-lg vaRow ml-4" title="nächster Monat" id="nextmonth"></i>
					</div>
				</div>
			</div>
