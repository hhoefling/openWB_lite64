...
def main():
    ...
    if clientsocket is not None:
        try:
            ...
            tempmax   = rct_lib2.add_by_name(MyTab, "battery.max_cell_temperature")
            tempmin   = rct_lib2.add_by_name(MyTab, "battery.min_cell_temperature")
...
#            rct_lib2.add_by_name(MyTab, "battery.stack_software_version[6]")
            ...
            tempmin =  int(tempmin.value * 100) / 100.0
            tempmax =  int(tempmax.value * 100) / 100.0
            bt = int(bxt.value * 100) / 100.0 
            print( "Cell Temp.           : "  + str(bt) + ' Grad (Max:' + str(tempmax) + ' Grad, Min:'+str(tempmin) + ')'  )
