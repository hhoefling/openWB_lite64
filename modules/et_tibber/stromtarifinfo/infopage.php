						...
						<div class="row justify-content-center">
							<div class="col-8 col-sm-6 col-md-5 col-lg-4">
								<div class="input-group mb-3">
									<i class="fa fa-caret-square-left fa-lg vaRow mr-4" title="vorheriger Tag" id="prevday"></i>
									...
									<i class="fa fa-caret-square-right fa-lg vaRow ml-4" title="nächster Tag" id="nextday"></i>
								</div>
							</div>
						</div>
						<div class="row">
